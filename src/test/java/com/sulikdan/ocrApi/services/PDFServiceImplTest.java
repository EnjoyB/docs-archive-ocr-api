...
class PDFServiceImplTest {
  ...
  @Mock PDDocumentWrapper pdDocumentWrapper;

  @Mock List<Path> covnertedPaths;

  @Mock List<DocumentAsyncStatus> documentAsyncStatuses;
  ...
  void processPDFs() {
    ...
    documentStorageService.getDocumentAsyncMap().put(anyString(), any(DocumentAsyncStatus.class));
