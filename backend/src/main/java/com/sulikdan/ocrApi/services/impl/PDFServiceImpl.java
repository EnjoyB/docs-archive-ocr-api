...
import static com.sulikdan.ocrApi.services.impl.DocumentServiceImpl.generateNamePrefix;
...
public class PDFServiceImpl implements PDFService {
    ...
    public PDFServiceImpl(@Qualifier("threadPoolTaskExecutor") TaskExecutor taskExecutor, DocumentStorageService documentStorageService, FileStorageService fileStorageService, OCRService ocrService, PDDocumentWrapper pdDocumentWrapper) {
